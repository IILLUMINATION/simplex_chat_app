...
class AppLocalizations {
  ...
  static const Map<String, String> _ru = {
    ...
    'create': 'Создать',
    'profile_default_name': 'Профиль',
    'profile_tap_to_view': 'Нажмите, чтобы открыть профиль',
    'settings': 'Настройки',
    'theme': 'Тема',
    ...
    'sticker_pack_exported_to': 'Экспортировано в %s',
  ...
  static const Map<String, String> _en = {
    ...
    'profile_tap_to_view': 'Tap to view profile',
    'settings': 'Settings',
    ...
    'import': 'Import',
    'sticker_pack_exported_to': 'Exported to %s',
