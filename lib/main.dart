...
import 'src/ui/core/plugins/renderers/image_message_renderer.dart';
import 'src/ui/core/plugins/renderers/sticker_message_renderer.dart';
...
void _setupPlugins() {
  ...
  registry.registerRenderer(StickerMessageRenderer());
}
